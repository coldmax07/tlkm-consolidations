...
## Sender workflow
- Draft/Rejected: edit amount, save, send for review.
...
- Actions:
  - Sender: `PATCH /api/legs/{id}` (amount), `POST /api/legs/{id}/submit`, `POST /api/legs/{id}/approve`, `POST /api/legs/{id}/reject`.
